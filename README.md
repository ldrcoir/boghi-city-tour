...
بعد از نصب، بالای صفحه بوت باید «بوقی v0.9 — بیلد ۱۰» طلایی دیده شود — این یعنی نسخه درست اجرا شده. لینک‌های قدیمی هم اکنون فایل v0.9 می‌دهند.

### جدید در v0.9 — ماشین‌های زنده
- ۱۶ ماشین با هنر جدید چاق‌وبراق (چشم + لبخند) — یکدست با رفرنس‌های تاییدشده
- ۴ ماشین مسابقه‌ای جدید رنگی: پراید آبی، ۲۰۶ سبز، شاهین سفید، دنا سرخ کاپیتان
- موسیقی جدید «ماریمبای محله» (نرم و شاد بچگانه — جایگزین سنتور-فانک)
- پس‌زمینه‌ی نقاشی منو (برج آزادی + میلاد) و فیکس لمس دکمه‌ها روی گوشی
