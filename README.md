...
بعد از نصب، بالای صفحه بوت باید «بوقی v0.8 — بیلد ۹» طلایی دیده شود — این یعنی نسخه درست اجرا شده. لینک‌های قدیمی هم اکنون فایل v0.8 می‌دهند. اگر نصب نشد اول نسخه قبلی را uninstall کنید (کلید امضا عوض شده).
